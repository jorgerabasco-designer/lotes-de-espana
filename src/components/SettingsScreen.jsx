          ...
          {section === 'prompt' && (
            <div className="set-block">
              <div className="set-blockh">
                ...
                <p>
                  Plantilla base que Gemini 3 Pro utiliza para generar bodegones. Las variables <code>{'{PRODUCTS}'}</code> y <code>{'{N}'}</code> se sustituyen automáticamente con los productos seleccionados, sus dimensiones reales y su posición sugerida (TRASERA / MEDIA / DELANTERA). Las reglas de orientación (botellas de pie), fidelidad de etiquetas y cantidades exactas por producto se añaden siempre de forma automática.
                </p>
              </div>
