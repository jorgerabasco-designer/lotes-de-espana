...
export const SEED_PRODUCTS = [
  {
    ...
    cat: 'vinos',
    h: 30, w: 8, d: 8,
    tipo_envase: 'botella vidrio oscuro',
  ...
  },
  {
    ...
    cat: 'turrones',
    h: 9, w: 18.5, d: 2.2,
    tipo_envase: 'caja cartón rectangular plana',
  ...
  },
  {
    ...
    cat: 'turrones',
    h: 16, w: 8.5, d: 3,
    tipo_envase: 'caja cartón vertical estrecha',
  ...
  },
  {
    ...
    cat: 'snacks',
    h: 15, w: 6.4, d: 6.4,
    tipo_envase: 'caja cartón vertical cuadrada',
    color: 'mustard yellow and green',
    posicion: 'MEDIA',
  ...
  },
  {
    ...
    cat: 'conservas',
    h: 6.8, w: 11, d: 3,
    tipo_envase: 'lata rectangular plana',
  ...
  },
  {
    ...
    cat: 'snacks',
    h: 6, w: 6, d: 6,
    tipo_envase: 'tarro cristal con tapa negra',
    color: 'clear glass with green',
    posicion: 'DELANTERA',
